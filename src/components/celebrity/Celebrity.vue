<template>
    <div class="page">
        <div class="celebrity" v-if="subject.id">
            <div class="base">
                <div class="cover">
                    <img :src="subject.avatars.medium | handleImageUrl" width="92" alt="">
                </div>
                <div class="r">
                    <h3>{{subject.name}}</h3>
                    <ul>
                ...
                <div class="cont movies">
                    <section class="ii return_name" v-for="item in subject.works">
                        <router-link :to="{ name: 'Detail', params: { id: item.subject.id }}">
                            <img class="delay" :src="item.subject.images.small | handleImageUrl">
                            <div class="r">
